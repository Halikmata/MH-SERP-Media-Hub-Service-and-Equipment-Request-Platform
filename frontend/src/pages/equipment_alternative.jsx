...
const Equipment = ({ url }) => {
  ...
  function totalPage(){ // total pages 
  ...
  function query() {
    axios.get(`${url}/equipment?`, {
      ...
      sort: 1,
      limit_rows: 6, // total instances in one page
      },
    })
      .then(response => {
  ...
  return (
    <div className="container mt-5">
      ...
      <Row xs={1} md={2} lg={3} className="g-4">
        {equipment.map(item => ( // currentItems temporary
          <Col key={item.id}>
